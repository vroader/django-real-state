...
class Property(TimeStampedUUIDModel):
    ...
    ref_code = models.CharField(
        verbose_name=_("Porperty Reference Code"),
        max_length=255,
        unique=True,
        blank=True
    )
    ...
    street_address = models.CharField(verbose_name=_("Street Address"), max_length=150, default="Quadra 1")
    ...
    photo1 = models.ImageField(verbose_name=_("Photo 1"), default="/interior_sample.jpg", null = True, blank=True)
    photo2 = models.ImageField(verbose_name=_("Photo 2"), default="/exterior_sample.jpg", null = True, blank=True)
    photo3 = models.ImageField(verbose_name=_("Photo 3"), default="/bedroom_sample.jpg", null = True, blank=True)
    photo4 = models.ImageField(verbose_name=_("Photo 4"), default="/bathroom_sample.jpg", null = True, blank=True)
